...
namespace Comment_Review_Downloader.Extensions
{
    public class CsvWriter
    {
        ...
        public bool Write<T>(IList<T> list, string fileName, bool includeHeader = true)
        {
            string csv = this.Write(list, includeHeader);

            var done = this.WriteFile(fileName, csv);
